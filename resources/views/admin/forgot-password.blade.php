...
<head>
    ...
    <title>Lupa Password | SuryaPainting18</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .login-subtitle { font-size: 12px; color: #555; letter-spacing: 1px; text-transform: uppercase; margin-bottom: 32px; line-height: 1.6; }
        ...
        .login-footer { margin-top: 28px; text-align: center; display: flex; flex-direction: column; gap: 14px; }
        .login-footer a { font-family: 'Barlow Condensed', sans-serif; font-size: 12px; font-weight: 700; font-style: italic; letter-spacing: 2px; text-transform: uppercase; color: rgba(255,255,255,0.3); text-decoration: none; transition: color 0.2s; display: inline-flex; align-items: center; justify-content: center; gap: 6px; }
    ...
    <div class="login-wrap">
        <div class="login-box">
            ...
            <div class="login-card">
                ...
                <p class="login-subtitle">Masukkan email terdaftar Anda, kami akan kirimkan link reset password.</p>
                @if($errors->any())
                ...
                <form action="{{ route('admin.forgot-password.submit') }}" method="POST">
                    ...
                    <button type="submit" class="login-submit">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M22 12.85v2.15a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V9a2 2 0 0 1 2-2h5.5"/><polyline points="15 3 21 3 21 9"/><line x1="9" y1="15" x2="21" y2="3"/></svg>
                        Kirim Link Reset
                    </button>
                </form>
